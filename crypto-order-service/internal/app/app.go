...
import (
	...
	"github.com/Amir-Sadati/crypto-microservice/crypto-order-service/internal/database/postgres"
	grpchandler "github.com/Amir-Sadati/crypto-microservice/crypto-order-service/internal/handler/grpc"
...
func (a *App) Run() {
	...
	orderpb.RegisterOrderServiceServer(a.grpcServer, orderGrpcHandler)
